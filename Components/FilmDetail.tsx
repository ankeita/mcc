...
const FilmDetail = (props: any) => {
  ...
  useLayoutEffect(() => {
    if (film !== undefined && Platform.OS === 'android') {
      // Uniquement sur IOs et lorsque le film est chargé
  ...
  }); //l'effect sera évoqué à chaque modification de props.navigation
  ...
  const _displayFavoriteImage = () => {
    ...
    return <Image source={imageSource} style={styles.favorite_image} />;
  };
